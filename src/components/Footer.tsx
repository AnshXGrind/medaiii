...
import { Activity, Mail, Facebook, Twitter, Linkedin, Instagram, Stethoscope, User, Github } from "lucide-react";
  ...
  return (
    <footer className="bg-card border-t border-border mt-20">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col items-center justify-center gap-2 text-center text-sm text-muted-foreground">
